...
public class CustomerJpaDaoImpl implements CustomerDao{
    ...
    public void registerCustomer(CustomerDto customerDto) {
        ...
        Customer customer = new Customer(auditDto.getOpr_id(), auditDto.getOpr_trm_id(), auditDto.getMng_id(), auditDto.getOpr_id(), LocalDateTime.now(), LocalDateTime.now(), customerDto.getCus_no(), customerDto.getCus_nm(), customerDto.getCus_id(), customerDto.getCus_pw());
